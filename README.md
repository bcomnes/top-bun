...
Installing `@domstack/cli` installs a `domstack` bin.
...
- Running `domstack --watch` will build the site and start an auto-reloading development web-server that watches for changes.
