...
import { setMarkdownItSettings } from './page-builders/md/get-md.js'
...
export async function buildPagesDirect (src, dest, siteData, _opts) {
  ...
  // Initialize markdown-it settings if available
  if (siteData.markdownItSettings) {
    setMarkdownItSettings(siteData.markdownItSettings, siteData.markdownItSettings.filepath)
  }
