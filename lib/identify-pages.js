...
const layoutSuffixs = ['.layout.ts', '.layout.mts', '.layout.cts', '.layout.js', '.layout.mjs', '.layout.cjs']
const layoutClientSuffixs = ['.layout.client.ts', '.layout.client.mts', '.layout.client.cts', '.layout.client.js', '.layout.client.mjs', '.layout.client.cjs']
const layoutStyleSuffix = '.layout.css'
const templateSuffixs = ['.template.ts', '.template.mts', '.template.cts', '.template.js', '.template.mjs', '.template.cjs']
const globalStyleNames = ['global.css', 'global.style.css']
const globalClientNames = ['global.client.ts', 'global.client.mts', 'global.client.mts', 'global.client.js', 'global.client.mjs', 'global.client.cjs']
const globalVarsNames = ['global.vars.ts', 'global.vars.mts', 'global.vars.cts', 'global.vars.js', 'global.vars.mjs', 'global.vars.mjs']
